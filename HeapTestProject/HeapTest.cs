...
namespace HeapTestProject
{
    ...
    public class HeapTest
    {
        ...
        /// <summary>
        ///A test for BuildMaxHeap
        ///</summary>
        public void BuildMaxHeapTestHelper<T>()
            where T : IComparable<T>
        {
            Heap<int> target = new Heap<int>(); // TODO: Initialize to an appropriate value
            int[] array = {4,1,3,2,16,9,10,14,8,7}; // TODO: Initialize to an appropriate value
            
            target.BuildMaxHeap(ref array);
                    }

        [TestMethod()]
        public void BuildMaxHeapTest()
        {
            BuildMaxHeapTestHelper<int>();
        }
